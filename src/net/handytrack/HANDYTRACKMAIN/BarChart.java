...
public class BarChart extends JPanel {
    ...
    private final int barWidth = 50; // Fixed width for each bar
    private final Color[] colors = {Color.decode("#4CAF50"), Color.decode("#2196F3"), Color.decode("#FFC107"),
            Color.decode("#E91E63"), Color.decode("#9C27B0")}; // Different colors for bars
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (Map.Entry<String, Integer> entry : frequencyMap.entrySet()) {
            ...
            g.setColor(colors[colorIndex]); // เสร็จสี
            ...
            x += barWidth + 30; // Add some space between bars
        ...
        // Draw X-axis label
        g.drawString("Type", getWidth() / 2 - 20, getHeight() - 5);
    }

    @Override
    public Dimension getPreferredSize() {
        int width = frequencyMap.size() * (barWidth + 30); // Add space between bars
